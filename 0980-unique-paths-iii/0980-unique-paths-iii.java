...
// class Solution {
//     boolean[][] visited;
//     int rows, cols, startRow, startCol, totalSols, actualCountOfEmptySquares;
//     int[][] dirs = new int[][]{{0,1}, {1,0}, {-1,0}, {0,-1}};
...
//                     startRow = i;
//                     startCol = j;
//                     actualCountOfEmptySquares++; // start position is also an empty square
//                 }
//             }
//         }
...
//     public void backtrack(int[][] grid, int row, int col, int countOfEmptySquares){
//         if(grid[row][col] == 2){
//             if(countOfEmptySquares == actualCountOfEmptySquares)
//                 totalSols++;
//             return;
//         }
...
//                && !visited[nextRow][nextCol] && grid[nextRow][nextCol] != -1){
//                 visited[nextRow][nextCol] = true;
//                 backtrack(grid, nextRow, nextCol, countOfEmptySquares + 1);
//                 visited[nextRow][nextCol] = false;
//             }
//         }
//     }
