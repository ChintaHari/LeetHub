...
#     select first_orders.customer_id from first_orders JOIN Delivery ON first_orders.firstOrderDate = Delivery.order_date
#     where first_orders.firstOrderDate = Delivery.customer_pref_delivery_date
# )
